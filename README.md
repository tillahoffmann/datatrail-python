# 🐍 DataTrail in Python [![DataTrail in Python](https://github.com/tillahoffmann/datatrail-python/actions/workflows/main.yaml/badge.svg)](https://github.com/tillahoffmann/datatrail-python/)
